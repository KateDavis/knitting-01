...
public class Test_Integration_With_XML_02 {
	         ...
	         throws                MalformedURLException 
	{
		     ...
		     Directory_Triples     dir_t01     =  new Directory_Triples ( "Dir__Out_Base"
		                                                                ,  Dir__Out_Base
				                                                        );	
		     ...
		     return     new  Directory_Manager ( dir_t01 );
	}
	         ...
	         throws      MalformedURLException 
	{
		     ...
		     String      Dir__Resources        = "knitting-01/src_resources/com/knitting/resources";	
